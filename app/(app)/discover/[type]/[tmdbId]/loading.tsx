...
/**
 * /discover/[type]/[tmdbId] is the TMDB-detail view for titles not yet in the
 * library — same shape as /title/[id]: a full-bleed backdrop hero with a
 * single content column, then a cast grid and a recommendations grid. The
 * skeleton mirrors that layout so the content doesn't shift when it loads.
 */
